 ...
 * Compiled Tue, 09 May 2023 16:41:26 UTC
 */
(function (React, mobxReactLite, require$$0, filesaver, mobx, mui) {
	...
	const APP_VERSION = '1.06 (1.05.2023)';
	...
	class Functions {
	    generateXML(bank) {
	        ...
	        if (store.params[2].value) {
	            ...
	            this.setTPKey("MasteryPoints", 15, points, bank);
	            const plays = 10;
	...
	const Menu = mobxReactLite.observer((props) => {
	    ...
	    const logo = React.useMemo(() => {
	        return (jsxRuntimeExports.jsxs(Flex, { style: { flexDirection: 'row', alignItems: 'center' }, children: [jsxRuntimeExports.jsx("img", { src: 'assets/icons/favicon-32x32.png', width: '30', height: '30' }), jsxRuntimeExports.jsx(Label$1, { style: { fontSize: '20px' }, children: "Bank Generator" })] }));
	    }, []);
